...
ITEM_ID = 22416
ITEM_TT = ['Item Level 92', 'Binds when picked up', 'Chest Plate', '1027 Armor', '+21 Strength', '+43 Stamina',
           'Durability 165 / 165', 'Requires Level 60',
           'Equip:  [Increased Defense +13.](https://classic.wowhead.com/spell=14249)',
           'Equip:  [Increases your chance to dodge an attack by 1%.](https://classic.wowhead.com/spell=13669)',
           'Equip:  [Improves your chance to hit by 2%.](https://classic.wowhead.com/spell=15465)',
           "[Dreadnaught's Battlegear](https://classic.wowhead.com/item-set=523)  (0/9)",
           '\t* [Dreadnaught Bracers](https://classic.wowhead.com/item=22423)\n\t* [Dreadnaught Breastplate](https://classic.wowhead.com/item=22416)\n\t* [Dreadnaught Gauntlets](https://classic.wowhead.com/item=22421)\n\t* [Dreadnaught Waistguard](https://classic.wowhead.com/item=22422)\n\t* [Dreadnaught Helmet](https://classic.wowhead.com/item=22418)\n\t* [Dreadnaught Legplates](https://classic.wowhead.com/item=22417)\n\t* [Dreadnaught Pauldrons](https://classic.wowhead.com/item=22419)\n\t* [Dreadnaught Sabatons](https://classic.wowhead.com/item=22420)\n\t* [Ring of the Dreadnaught](https://classic.wowhead.com/item=23059)',
           '(2) Set :  [Increases the damage done by your Revenge ability by 75.](https://classic.wowhead.com/spell=28844)\n(4) Set :  [Improves your chance to hit with Taunt and Challenging Shout by 5%.](https://classic.wowhead.com/spell=28843)\n(6) Set :  [Improves your chance to hit with Sunder Armor, Heroic Strike, Revenge, and Shield Slam by 5%.](https://classic.wowhead.com/spell=28842)\n(8) Set :  [When your health drops below 20%, for the next 5 seconds healing spells cast on you help you to Cheat Death, increasing healing done by up to 160.](https://classic.wowhead.com/spell=28845)',
           'Sell Price: 12g 88s 87c']
...
class TestAbilitySearch(unittest.TestCase):
    ...
    def test_get_ability(self):
        ...
        self.assertEqual(ability['id'], ABILITY_ID,
                         'Expected ability id {}, but got {}'.format(ABILITY_ID, ability['id']))
    ...
    def test_search_for_ability(self):
        embeds = AS.search_for_ability(ABILITY_NAME)
        self.assertEqual(len(embeds), ABILITY_EMBEDS,
                         'Expected {} embeded tool tips, got {}'.format(ABILITY_EMBEDS, len(embeds)))

    def test_search_for_ability_fails(self):
        try:
            AS.search_for_ability('garbage string')
        except AS.AbilitySearchError:
            assert True
        else:
...
class TestItemSearch(unittest.TestCase):
    ...
    def test_search_for_item(self):
        embed = IS.search_for_item(ITEM_NAME)
